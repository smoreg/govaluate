...
func TestNoParameterEvaluation(test *testing.T) {
	...
	evaluationTests := []EvaluationTest{
		...
		{
			Name:       "IP in",
			Input:      "127.0.0.1 in (127.0.0.3, 127.0.0.2, 127.0.0.1)",
			Parameters: []EvaluationParameter{fooParameter},
			Expected:   true,
		},
		{
			Name:       "IP not in",
			Input:      "127.0.0.1 in (127.0.0.3, 127.0.0.2)",
			Parameters: []EvaluationParameter{fooParameter},
			Expected:   false,
		},
		{
			Name:       "CIDR in Network",
			Input:      "InNetwork(8.8.8.8, 8.8.8.255/20)",
			Parameters: []EvaluationParameter{fooParameter},
		...
		},
		{
			...
			Input:      "InNetwork(9.8.8.8, 8.8.8.255/20)",
			Parameters: []EvaluationParameter{fooParameter},
			Functions:  CIDRTestFunction,
			Expected:   false,
		},
